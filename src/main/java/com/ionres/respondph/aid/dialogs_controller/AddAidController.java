...
//                    new SpinnerValueFactory.IntegerSpinnerValueFactory(3, 3, 3, 1);
//            clusterSpinner.setValueFactory(valueFactory);
//            clusterSpinner.setEditable(false); // Cannot type
//            clusterSpinner.setDisable(true);   // Grayed out
//            clusterSpinner.getValueFactory().setValue(3); // Force value
//            clusterSpinner.valueProperty().addListener((obs, oldValue, newValue) -> {
//                if (newValue != 3) {
...
public class AddAidController {
    ...
    private void clearFields() {
        ...
        // Cluster count is fixed at 3 - no need to reset
